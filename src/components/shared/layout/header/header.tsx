            ...
            <div className="flex items-center gap-7 max-sm:gap-4">
              ...
              <Link href="/cart">
                <Button
                  size="sm"
                  variant="link"
                  className="relative p-1 text-dark hover:text-primary h-auto"
                  title="Go to shopping cart"
                >
                  <span className="absolute -right-1 top-0 w-3 h-3 font-medium text-[10px] leading-[100%] rounded-full bg-primary text-primary-foreground flex items-center justify-center">
                    3
                  </span>
                  <svg
                    width="24"
